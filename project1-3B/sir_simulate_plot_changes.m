function [S, I, R, W] = sir_simulate_noround(s_0, i_0, r_0, beta, gamma, delta, num_steps)
...
for step = 2 : num_steps
    [s, i, r] = sir_step_noround(s, i, r, beta, gamma, delta);
    S(step) = s;
    I(step) = i;
    R(step) = r;
    
    plot(step, dInfected, 'r^');
    plot(step, dRecovered, 'g^');
    plot(step, dResusceptible, 'b^');
end
